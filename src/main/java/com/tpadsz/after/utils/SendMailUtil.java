...
public class SendMailUtil {
    ...
    static String FROM = "18170756879@163.com"; // 发件人地址
    static String TO = "766256898@qq.com"; // 收件人地址
    static String AFFIX = ""; // 附件地址
    static String AFFIXNAME = ""; // 附件名称
    static String USER = "18170756879@163.com"; // 用户名
    static String PWD = "auth001"; // 163的授权码
    static String SUBJECT = "测试邮件"; // 邮件标题
    static String[] TOS = {"766256898@qq.com","after@tpadsz.com"};
...
//    }
    ...
    public static void send(String context) {
        ...
        try {
            ...
            transport.connect(HOST,465, USER, PWD);//连接服务器的邮箱
